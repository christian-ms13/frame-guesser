...
export function IconLight({ className = "w-5 h-5" }: IconProps) {
  return (
...
export function IconDark({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg xmlns = "http://www.w3.org/2000/svg" viewBox = "0 -960 960 960" fill = "currentColor" className = {className}>
...
export function IconSystemSettings({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg xmlns = "http://www.w3.org/2000/svg" viewBox = "0 -960 960 960" fill = "currentColor" className = {className}>
...
export function IconRoutine({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg xmlns = "http://www.w3.org/2000/svg" viewBox = "0 -960 960 960" fill = "currentColor" className = {className}>
