...
export default function Tooltip({ children, text, active = true }: TooltipProps): React.ReactNode {
  return (
    <div className = "group relative flex items-center justify-center">
      ...
      {active && (
        <span className = "absolute bottom-full mb-2.5 flex flex-col items-center opacity-0 group-hover:opacity-100 transition-all duration-75 delay-400 ease-out transform translate-y-1 group-hover:translate-y-0 pointer-events-none z-50">
